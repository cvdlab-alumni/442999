...
###Griglia piano terra divisa in parti
...
###Definizione di due cerchi da usare nella griglia
def mycircle(r=2.3,n=32):
    return CIRCLE(r)([n,1])

part7f0= mycircle()

def mycircle1(r=1.2,n=32):
    return CIRCLE(r)([n,1])

part8f0=mycircle1()

floor0=STRUCT([part0f0,part1f0,part2f0,part3f0,part4f0,part5f0,part6f0,part9f0,T([1,2])([19,11])(part7f0),T([1,2])([4.3,4.3])(part8f0)])
//VIEW(floor0)
###Griglia 1° piano divisa in parti
